...
Orbit is a web-based graphical user interface that simplifies XDM operations.
You can set up Orbit in a sandbox demo mode or as a registered instance. Once
Orbit is configured, you can unlink it from a XDM instance as well.
...
.. toctree::
  :maxdepth: 1
   ...
   Unlink Orbit from XDM <Unlinking_Orbit>   

Registering Orbit to XDM
--------------------------

Orbit can be run as a user interface to XDM no matter where or how XDM is
hosted. You can deploy XDM on any host running Kubernetes 1.11.3 or
