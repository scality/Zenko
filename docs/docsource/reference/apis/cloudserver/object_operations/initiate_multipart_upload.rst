...
.. table::
   ...
   |                                     |        | stored and returned as a set of key-\    |
   |                                     |        | value pairs. |product| does not validate |
...
to specific accounts or groups, each of which maps to specific |product|  
...
headers supported by the |product| (see :ref:`Common Response Headers`).
