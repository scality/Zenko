...
KEYCLOAK_ENDPOINT="http://keycloak.default.svc.cluster.local"
...
kubectl run ${POD_NAME} \
  ...
  --env="STAGE=${STAGE}" \
  -- sh -c "cd node_tests && UI_ENDPOINT=${UI_ENDPOINT} KEYCLOAK_ENDPOINT=${KEYCLOAK_ENDPOINT} npm run test_ui"
