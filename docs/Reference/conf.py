...
html_logo = '_static/Zenko Logo Horizontal.png'
...
htmlhelp_basename = 'ZenkoReferencedoc'
...
latex_documents = [
    (master_doc, 'ScalityZenkoReference.tex', 'Zenko Reference Guide',
...
man_pages = [
    (master_doc, 'scalityzenkoreference', 'Zenko Reference Guide',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ScalityZenkoReference', 'Zenko Reference Guide',
     'Tehcnical Publications', 'ScalityZenkoReference', 'Zenko API documentation.',
     'manual'),
]
