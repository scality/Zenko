...
latex_documents = [
    (master_doc, 'ZenkoInstallation.tex', 'Zenko Installation',
...
texinfo_documents = [
    (master_doc, 'ZenkoInstallation', 'Zenko Installation',
    'Scality Technical Publications', 'Zenko Installation', 'Documentation',
     'manual'),
]
