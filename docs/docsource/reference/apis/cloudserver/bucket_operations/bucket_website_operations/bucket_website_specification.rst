...
XDM   implements the `AWS S3 Bucket Website APIs
...
To set up XDM   with website endpoints, in Federation env_s3 should have a
...
bucket foo, a bucket website request to XDM   would be made to
...
.. note::
  ...
  policy to set all objects to public, but XDM   does not yet implement bucket
