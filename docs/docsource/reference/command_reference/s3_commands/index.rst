...
AWS includes basic funtionality for S3 commands, which emulate Unix
...
set, maintained separately to reflect operations available for S3 Connector.
...
See example in ``cp`` to illustrate this description.
