...
Scality's S3 Connector provides a Service Utilization API (UTAPI) for resource
...
is integrated with the S3 Connector IAM policies for access control through the
