Feature: Assume Role with Web Identity
  ...
  Scenario Outline: Assume Role with Web Identity
    ...
    Examples:
      ...
      | PutObjectVersionTagging    | STORAGE_MANAGER       | S3Standard    | with           | exists         |
      | GetObjectVersionAcl        | STORAGE_MANAGER       | S3Standard    | with           | exists         |
      | PutObjectVersionAcl        | STORAGE_MANAGER       | S3Standard    | with           | exists         |
      ...
      | PutObjectVersionTagging    | STORAGE_ACCOUNT_OWNER | S3Standard    | with           | exists         |
      | GetObjectVersionAcl        | STORAGE_ACCOUNT_OWNER | S3Standard    | with           | exists         |
      | PutObjectVersionAcl        | STORAGE_ACCOUNT_OWNER | S3Standard    | with           | exists         |
      ...
      | PutObjectVersionTagging    | DATA_CONSUMER         | S3Standard    | with           | exists         |
      | GetObjectVersionAcl        | DATA_CONSUMER         | S3Standard    | with           | exists         |
      | PutObjectVersionAcl        | DATA_CONSUMER         | S3Standard    | with           | exists         |
  ...
  Scenario Outline: Assume Role with Web Identity bucket setting tests
    ...
    Examples:
      ...
      | GetObjectVersionRetention        | STORAGE_MANAGER       | with           | exists         | Bucket is missing Object Lock Configuration |
      | GetObjectVersionLegalHold        | STORAGE_MANAGER       | with           | exists         | Bucket is missing Object Lock Configuration |
      ...
      | GetObjectVersionRetention        | STORAGE_ACCOUNT_OWNER | with           | exists         | Bucket is missing Object Lock Configuration |
      | GetObjectVersionLegalHold        | STORAGE_ACCOUNT_OWNER | with           | exists         | Bucket is missing Object Lock Configuration |
      ...
      | GetObjectVersionRetention        | DATA_CONSUMER         | with           | exists         | Bucket is missing Object Lock Configuration |
      | GetObjectVersionLegalHold        | DATA_CONSUMER         | with           | exists         | Bucket is missing Object Lock Configuration |
