...
Feature: S3 Bucket Policies Authorization flow for Federated Identities
    This feature allows you to create and attach bucket policies to S3 buckets.
    Federated Identities should have the permissions to perform the actions that they are granted in their bucket policies
    ...
    @PreMerge
    @BucketPolicies
    @BP-AssumeRoleWithWebIdentity
    Scenario Outline: <iamPolicyExists> <iamPolicyApplies> <iamPolicyEffect> IAM Policy and <bucketPolicyExists> <bucketPolicyApplies> <bucketPolicyEffect> S3 Bucket Policy
