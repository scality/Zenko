const fs = require('fs');
const { getConfig, VAULT_ENDPOINT } = require('tests_common/configuration');
const {
    IAMClient,
...
class VaultClient {
    ...
    static getAdminClient() {
        const adminCredentials = {
            accessKey: getConfig().AdminCredentials.accessKey,
            secretKeyValue: getConfig().AdminCredentials.secretKey,
        };
