...
Feature: S3 Bucket Policies Authorization flow for ASSUME_ROLE_USER
    This feature allows you to create and attach bucket policies to S3 buckets.
    ASSUME_ROLE_USER should have the permissions to perform the actions that they are granted in their bucket policies
    ...
    @BucketPolicies
    @BP-Account
    Scenario Outline: ASSUME_ROLE_USER: <iamPolicyExists> <iamPolicyApplies> <iamPolicyEffect> IAM Policy and <bucketPolicyExists> <bucketPolicyApplies> <bucketPolicyEffect> S3 Bucket Policy
