...
async function extractAndCacheParameters(parameters: ZenkoWorldParameters): Promise<void> {
    ...
    const setupParameters = {
        ...
        StorageManagerUsername: 'storage_manager',
        StorageAccountOwnerUsername: 'storage_account_owner',
        DataConsumerUsername: 'data_consumer',
        DataAccessorUsername: 'data_accessor',
