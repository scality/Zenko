...
# NOTE: KEYCLOAK_TEST_USER is already set with -norights suffix by load-config.sh
...
run_e2e_test() {
    kubectl run ${1} ${POD_NAME} \
        ...
        --env=MIRIA_BACKEND_DESTINATION_LOCATION=${MIRIA_BACKEND_DESTINATION_LOCATION} \
