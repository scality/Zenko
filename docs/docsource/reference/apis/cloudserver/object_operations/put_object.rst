...
.. note::
  ...
  |product| never adds partial objects; if a success response is received, |product|  added the
...
.. table::
   ...
   |                                         |        | key-value pairs. |product| does not    |
...
to specific |product| accounts or groups, each of which maps to specific
