...
XDM   may return the following AWS error messages, which are available to the
...
XDM   also may return the following non-AWS S3 error message during a multipart
upload:
