...
``--encoding-type`` (string)
  ...
  you can add this parameter to request XDM   to encode the keys in the
  response.
...
IsTruncated -> (Boolean)
  ...
  This flag indicates whether XDM   returned all results that satisfied
  the search criteria.
...
NextMarker -> (string)
  ...
  request to get next set of objects. XDM   lists objects in alphabetical
  order.
