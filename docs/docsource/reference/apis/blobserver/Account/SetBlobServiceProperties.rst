...
.. note::
   ...
   Although CORS rules are listed in this schema, XDM  version |version| does not
...
XDM  implements a subset of these elements as default values in the
...
.. table::
   ...
   |                                    | Logging settings. Disabled in XDM version   |
   |                                    | |version|.                                  |
   +------------------------------------+---------------------------------------------+
   ...
   |                                    | Disabled in XDM version |version|.          |
   +------------------------------------+---------------------------------------------+
   ...
   |                                    | aggregates for blobs. Disabled in XDM       |
   |                                    | version |version|.                          |
   +------------------------------------+---------------------------------------------+
   ...
   |                                    | each minute for blobs. Disabled in XDM      |
   |                                    | version |version|.                          |
   +------------------------------------+---------------------------------------------+
   ...
   |                                    | ``2018-03-28`` in XDM version |version|.    |
   +------------------------------------+---------------------------------------------+
