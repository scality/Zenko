...
XDM operates by establishing and managing a namespace of data. For select
object stores, XDM does not have to create a namespace; rather, it can read an
existing namespace and use it as its own. This process of metadata ingestion
makes it easier to manage existing data stores, as XDM can "go back in time"
