...
XDM is Scality's multi-cloud storage controller. It provides a single point of
...
Using XDM, you can store to a Scality RING storage device and automatically
...
The XDM open-source project, described at https://www.zenko.io/ and hosted on
...
Based on the latest stable branch of open-source XDM, the XDM Enterprise
...
XDM can be accessed and managed through the Orbit GUI, or using direct API
calls. Because Orbit acts as a seamless management interface to XDM, people
may confuse the interface (Orbit) with the underlying logic (XDM). You can
access XDM from Orbit, or from the command line. Where it makes sense, Scality
provides APIs to help customize, automate, and improve interactions with XDM.
