...
JavaScript Object Notation (JSON). XDM uses it for several tasks;
...
storage. Additionally, XDM uses MongoDB to retain and order metadata
...
As deployed in XDM, MongoDB also ingests status, log information, and
metrics from Prometheus.

MongoDB is essential to the following XDM features:
