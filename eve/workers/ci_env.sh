...
FLAGS="\
--$CLI_FLAG ${CI_PREFIX}ARTIFACTS_USER=$ARTIFACTS_USER \
--$CLI_FLAG ${CI_PREFIX}ARTIFACTS_NAME=$ARTIFACTS_NAME \
--$CLI_FLAG ${CI_PREFIX}ARTIFACTS_PASSWORD=$ARTIFACTS_PASSWORD \
--$CLI_FLAG ${CI_PREFIX}ARTIFACTS_URL=$ARTIFACTS_URL \
