...
One of several dashboards available to XDM   users, Prometheus provides insight
into Kubernetes platform (MetalK8s) and XDM   functionality.
...
- **fromLocation:** The name of the source XDM   location 
...
- **toLocation:** The name of the target XDM   location
