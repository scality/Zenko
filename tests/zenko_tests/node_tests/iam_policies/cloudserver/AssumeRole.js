...
testAPIs.forEach(testAPI => {
    ...
    const account1Name = `iam-policies-assume-role-test-account1-${testAPI.API}`;
    const account1Info = {
    ...
    const account2Name = `iam-policies-assume-role-test-account2-${testAPI.API}`;
    const account2Info = {
    ...
    const userName = `iam-policies-assume-role-test-user${testAPI.API}`;

    let allowAssumeRolePolicyArn = null;

    const bucket1 = `bucket1-${testAPI.API}`;
    const bucket2 = `bucket2-${testAPI.API}`;
