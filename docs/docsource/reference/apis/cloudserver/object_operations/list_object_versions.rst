...
The request uses the following URI parameters.
   ...
   ``encoding-type``
      ...
      request that S3 Connector encode the keys in the response.
...
XML-formatted data:
   ...
   ``EncodingType``
      ...
      Encoding type used by S3 Connector to encode object key names in the XML
      response.
   ...
   ``IsTruncated``
      ...
      This flag indicates whether S3 Connector returned all results satisfying
