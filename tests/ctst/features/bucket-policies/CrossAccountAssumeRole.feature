...
Feature: S3 Bucket Policies Authorization flow for Cross Account Assumed Roles
    This feature allows you to create and attach bucket policies to S3 buckets.
    Cross Account Assumed Roles should have the permissions to perform the actions that they are granted in their bucket policies
